    ...
    <>
     ...
     <div className="about">
       <div className="left" >
        ...
        <a href="./priyanshu_kaushik_resume.pdf" download><button className="Btn" style={{color:"black"}}>Download CV</button></a>
       </div>
     ...
     <div className="right">
       <div className="content-container">
        <div className="content-stack-top">
            <img src="https://cdn.dribbble.com/users/1068771/screenshots/14225432/media/0da8c461ba3920a8c827d864a6e051ed.jpg?compress=1&resize=400x300" className="img" alt="mongodb img"/>
        </div>
     
        <div className="content-stack-bottom">
            <img src="https://thumbs.dreamstime.com/z/coder-icon-programming-languages-web-development-tre-trendy-flat-style-isolated-blue-background-152104143.jpg" className="img" alt="mongodb img"/>
        </div>
