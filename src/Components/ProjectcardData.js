...
const ProjectCardData = [

    {
        ...
        tool:"HTML | CSS | JS",
        text:"Thriving Facebook community and top-ranked prodcast, Any inspires a grounded, tangible and self-affirming sense of its a really can do this for over 100,000 online enterpreneurs. Beat-selling marketing courses",
    ...
    },
    {
        ...
        title:"Ecommerce Website Design",
        tool:"HTML | CSS | JS | REACT |JSON SERVER  ",
        text:"Max Fashion is an Indian fashion brand under the banner of the Mumbai based Landmark Group. That was opened by an Indian foreigner in the UAE, Micky Jagtiani The brand was first launched in May 2004, in the Middle East in UAE",
